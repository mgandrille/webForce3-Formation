...
class UserFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $userAdmin = new User();
        $userAdmin->setEmail('admin@notaresto.com');
        ...
        $userClient->setPassword($this->encoder->encodePassword($userAdmin, '1234'));
        ...
        $userRestaurateur->setPassword($this->encoder->encodePassword($userAdmin, 'resto'));
